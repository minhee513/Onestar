...
public class Quiz6 : MonoBehaviour
{
    ...
    public GameObject quiz7Object; // Quiz3 오브젝트를 담을 변수
    ...
    private void ShowCorrectPopup()
    {
        ...
        StartCoroutine(ShowQuiz7Object());
    }
    ...
    private System.Collections.IEnumerator ShowQuiz7Object()
    {
        yield return new WaitForSeconds(1.5f);
        gameObject.SetActive(false); // Quiz2 오브젝트 비활성화
        quiz7Object.SetActive(true); // Quiz3 오브젝트 활성화
    }
