...
public class Quiz2 : MonoBehaviour
{
    ...
    public AudioClip quiz2Sound;

    public GameObject quiz3Object; // Quiz3 오브젝트를 담을 변수
    ...
    private void ShowCorrectPopup()
    {
        ...
        StartCoroutine(ShowQuiz3Object());
    }
    ...
    private System.Collections.IEnumerator ShowQuiz3Object()
    {
        yield return new WaitForSeconds(1.5f);
        gameObject.SetActive(false); // Quiz2 오브젝트 비활성화
        quiz3Object.SetActive(true); // Quiz3 오브젝트 활성화
    }
