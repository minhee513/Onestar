...
public class Quiz4 : MonoBehaviour
{
    ...
    public AudioClip quiz4Sound;

    public GameObject quiz5Object; // Quiz3 오브젝트를 담을 변수
    ...
    private void ShowCorrectPopup()
    {
        ...
        StartCoroutine(ShowQuiz5Object());
    }
    ...
    private System.Collections.IEnumerator ShowQuiz5Object()
    {
        yield return new WaitForSeconds(1.5f);
        gameObject.SetActive(false); // Quiz2 오브젝트 비활성화
        quiz5Object.SetActive(true); // Quiz3 오브젝트 활성화
    }
