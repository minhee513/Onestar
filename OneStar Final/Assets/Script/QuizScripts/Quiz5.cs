...
public class Quiz5 : MonoBehaviour
{
    ...
    public GameObject quiz6Object; // Quiz3 오브젝트를 담을 변수
    ...
    private void ShowCorrectPopup()
    {
        ...
        StartCoroutine(ShowQuiz6Object());
    }
    ...
    private System.Collections.IEnumerator ShowQuiz6Object()
    {
        yield return new WaitForSeconds(1.5f);
        gameObject.SetActive(false); // Quiz2 오브젝트 비활성화
        quiz6Object.SetActive(true); // Quiz3 오브젝트 활성화
    }
